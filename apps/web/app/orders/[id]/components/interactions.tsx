...
const Interactions = () => {
  ...
  return (
    <div
      className="no-scrollbar mr-10 ml-2 flex h-[70%] w-full min-w-0 shrink flex-col gap-4 overflow-y-auto border-t border-r-0 border-l-0 border-gray-200 border-b-0 p-0"
