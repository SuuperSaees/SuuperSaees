...
import { getPrimaryOwnerId, getStripeAccountID } from 'node_modules/@kit/team-accounts/src/server/actions/members/get/get-member-account';
...
export default withI18n(() => (
  <ServicesPageClient accountId={primary_owner_user_id} accountIds={accountIds} stripeId={stripeId}/>
));