...
export default function AuthLayout({ children, authDetails, isLoading = false }: AuthLayoutProps) {
  ...
  return (
    <div className="justify-between flex text-center items-center h-screen w-screen">
