...
CREATE INDEX idx_orders_v2_agency_active ON public.orders_v2 USING btree (agency_id, created_at DESC) WHERE (deleted_on IS NULL);

CREATE INDEX idx_orders_v2_agency_performance_new ON public.orders_v2 USING btree (agency_id, deleted_on, created_at DESC);
...
CREATE INDEX orders_v2_agency_id_idx ON public.orders_v2 USING btree (agency_id);
...
CREATE INDEX orders_v2_status_id_idx ON public.orders_v2 USING btree (status_id);
