alter table "public"."orders_v2" add column "position" bigint;

CREATE INDEX idx_orders_v2_position_status_agency ON public.orders_v2 USING btree (agency_id, status, "position");

set check_function_bodies = off;

CREATE OR REPLACE FUNCTION public.update_order_with_position(
    p_order_id bigint,
