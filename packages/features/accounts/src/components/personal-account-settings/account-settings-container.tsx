...
export function PersonalAccountSettingsContainer(
  ...
  const { accountBillingTab, setAccountBillingTab, upgradeSubscription } =
    useBilling();
  ...
  const { updateOrganizationSetting } = useOrganizationSettings();
  ...
  return (
    <div>
      <Tabs
        defaultValue={getDefaultTab(role)}
        value={accountBillingTab}
        onValueChange={(value: string) => setAccountBillingTab(value)}
      >
        {shouldShowTabsList(role) && (
          <div className="flex items-center pb-[24px] w-full">
          ...
          <TabsContent value="profile">
            <ProfileSettings
              ...
              userSettings={{
                ...
                picture_url:
                  userSettings?.picture_url ?? workspace?.picture_url ?? "",
